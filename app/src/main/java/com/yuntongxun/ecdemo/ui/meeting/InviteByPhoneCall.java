...
public class InviteByPhoneCall extends MeetingBaseActivity {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.text_right:
                ...
                if(TextUtils.isEmpty(mPhoneNumber) || !CheckUtil.isMobileNO(mPhoneNumber)){
    ...
    private void doInviteMobileMember(String phoneNumber) {
        ...
        showProcessDialog();
        meetingManager.inviteMembersJoinToVoiceMeeting(mMeetingNo, new String[]{phoneNumber} , true,
