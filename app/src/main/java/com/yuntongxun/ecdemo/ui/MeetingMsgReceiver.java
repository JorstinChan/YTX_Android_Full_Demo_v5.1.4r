 ...
 * Created by Jorstin on 2015/7/25.
 */
public class MeetingMsgReceiver implements OnMeetingListener{
    ...
    public static void addVoiceMeetingListener(OnVoiceMeetingMsgReceive receiver) {
        ...
        getInstance().sObserver.add(new WeakReference<OnVoiceMeetingMsgReceive>(receiver));
    }

    public static void removeVoiceMeetingListener(OnVoiceMeetingMsgReceive receiver) {
        if(getInstance().sObserver == null && getInstance().sObserver.isEmpty()) {
            return ;
        }
    ...
    public static void putInterPhone(String meetingNo) {
        ECInterPhoneInviteMsg inviteMsg = new ECInterPhoneInviteMsg(ECInterPhoneMeetingMsg.ECInterPhoneMeetingMsgType.INVITE);
