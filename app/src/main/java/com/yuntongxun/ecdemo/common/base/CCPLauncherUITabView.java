...
public class CCPLauncherUITabView extends RelativeLayout implements View.OnClickListener {
    ...
    private void init() {
        ...
        RelativeLayout.LayoutParams imageViewLayoutParams = new RelativeLayout.LayoutParams(-1, DensityUtil.fromDPToPix(getContext(), 3));
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if(mIndicatorBitmap == null || mIndicatorBitmap.getWidth() != mTabViewBaseWidth) {
            ...
            canvas.drawColor(getResources().getColor(R.color.red_btn_color_normal));
